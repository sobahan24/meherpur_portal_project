...
@section('title')
মেহেরপুর জেলা | অতিরিক্ত জেলা প্রশাসক (সার্বিক)
@endsection

@section('contant')
<div id="printable_area">
    <h4>
        অতিরিক্ত জেলা প্রশাসক ( সার্বিক) </h4>
    <div id="vtab">
        <ul>
        ...
        <div class="row" style="display: none;">
            ...
            <ul>
                ...
                <li><a href="#" title="ত্রাণ ও পুনর্বাসন শাখা">ত্রাণ ও পুনর্বাসন শাখা</a></li>
                <li><a href="#" title="প্রবাসী কল্যাণ শাখা">প্রবাসী কল্যাণ শাখা</a></li>
                <li><a href="#" title="শিক্ষা শাখা ">শিক্ষা শাখা </a></li>
                <li><a href="#" title="নেজারত শাখা">নেজারত শাখা</a></li>
                <li><a href="#" title="সংস্থাপন শাখা">সংস্থাপন শাখা</a></li>
                <li><a href="#" title="সাধারণ শাখা">সাধারণ শাখা</a></li>
