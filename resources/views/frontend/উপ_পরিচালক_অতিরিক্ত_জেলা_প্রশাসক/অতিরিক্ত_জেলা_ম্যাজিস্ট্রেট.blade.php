...
@section('title')
মেহেরপুর জেলা | অতিরিক্ত জেলা ম্যাজিস্ট্রেট
@endsection

@section('contant')
<div id="printable_area">
    <h4>
        অতিরিক্ত জেলা ম্যাজিস্ট্রেট</h4>
    <div id="vtab">
        <ul>
        ...
        <div class="row" style="display: none;">
            ...
            <ul>
                ...
                <li><a href="#" title="জেএম শাখা">জেএম শাখা</a></li>
                <li><a href="#" title="ট্রেজারি শাখা">ট্রেজারি শাখা</a></li>
            </ul>
        </div>
    </div>
    <style>
