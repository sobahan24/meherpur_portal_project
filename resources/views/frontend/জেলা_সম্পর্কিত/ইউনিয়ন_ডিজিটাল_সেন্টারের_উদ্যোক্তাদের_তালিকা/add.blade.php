...
@section('title')
মেহেরপুর জেলা | ইউপি উদ্যোক্তা | সংযোজন
@endsection

@section('contant')
<div id="printable_area">
    <h3>ইউপি উদ্যোক্তাদের তথ্য সংযোজন</h3>
    <div style="border: 1px solid #e9e2e2; padding:5px">
        ...
        <form action="{{ url('/জেলা-সম্পর্কিত/ইউনিয়ন-ডিজিটাল-সেন্টারের-উদ্যোক্তাদের-তালিকা/insert') }}" method="POST" enctype="multipart/form-data" style="padding: 10px; background: #dedede24;">
            @csrf
            <div class="mb-3">
