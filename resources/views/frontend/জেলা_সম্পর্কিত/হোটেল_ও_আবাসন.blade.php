...
<div id="printable_area">
    ...
    <table class="bordered" style="text-align: center;">
        <tbody>
            ...
            <tr>
                <td>১</td>
                <td><a  href="#" title="জেলা পরিষদ ডাকবাংলো">জেলা পরিষদ ডাকবাংলো</a></td>
            ...
            <tr>
                <td>২</td>
                <td><a  href="#" title="সার্কিট হাউজ, মেহেরপুর">সার্কিট হাউজ, মেহেরপুর</a></td>
            ...
            <tr>
                <td>৩</td>
                <td><a  href="#" title="পরিদর্শন বাংলো, মুজিবনগর">পরিদর্শন বাংলো, মুজিবনগর</a></td>
                <td>জেলা পরিষদ, মেহেরপুর</td>
            ...
            <tr>
                <td>৪</td>
                <td><a  href="#" title="গেস্ট হাউজ, সড়ক ও জনপথ বিভাগ">গেস্ট হাউজ, সড়ক ও জনপথ বিভাগ</a></td>
            ...
            <tr>
                <td>১</td>
                <td><a  href="#" title="পৌর গেস্ট হাউজ, পৌর হল">পৌর গেস্ট হাউজ, পৌর হল</a></td>
            ...
            <tr>
                <td>২</td>
                <td><a  href="#" title="গেস্ট হাউজ, মেহেরপুর পল্লী বিদুৎ সমিতি">গেস্ট হাউজ, মেহেরপুর পল্লী বিদুৎ সমিতি</a></td>
                <td>ব্যবস্থাপক</td>
            ...
            <tr>
                <td>৩</td>
                <td><a  href="#" title="ফিন টাওয়ার আবাসিক হোটেল">ফিন টাওয়ার আবাসিক হোটেল</a></td>
                <td>ব্যবস্থাপক</td>
            ...
            <tr>
                <td>৪</td>
                <td><a  href="#" title="নাইট বিলাস আবাসিক হোটেল">নাইট বিলাস আবাসিক হোটেল</a></td>
            ...
            <tr>
                <td>৫</td>
                <td><a  href="#" title="অনাবিল আবাসিক হোটেল">অনাবিল আবাসিক হোটেল</a></td>
            ...
            <tr>
                <td>৬</td>
                <td><a  href="#" title="শাহাজাদী আবাসিক হোটেল">শাহাজাদী আবাসিক হোটেল</a></td>
            ...
            <tr>
                <td>৭</td>
                <td><a  href="#" title="প্রিন্স আবাসিক হোটেল">প্রিন্স আবাসিক হোটেল</a></td>
            ...
            <tr>
                <td>৮</td>
                <td><a  href="#" title="মিতা আবাসিক হোটেল">মিতা আবাসিক হোটেল</a></td>
