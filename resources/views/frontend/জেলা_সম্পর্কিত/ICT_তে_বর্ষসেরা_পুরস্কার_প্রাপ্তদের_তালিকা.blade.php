...
@section('title')
মেহেরপুর জেলা | ICT তে বর্ষসেরা পুরস্কার প্রাপ্তদের তালিকা
@endsection

@section('contant')
<div id="printable_area">

    <h3>ICT তে বর্ষসেরা পুরস্কার প্রাপ্তদের তালিকা </h3>
    <div>
        ...
        <table border="1" cellpadding="0" cellspacing="0">
            <tbody style="font-size:13px;">
                <tr style="font-weight: bold;">
                    ...
                    <td style="width:43%">
                        <p style="text-align: center;">মনোণীত ব্যক্তি/প্রতিষ্ঠানের নাম</p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="height:30px; width:43%">
                        <p style="text-align: center;"> জেলা ইনোভেশন টিম, মেহেরপুর।</p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="height:29px; width:43%">
                        <p style="text-align: center;">পৌর  ডিজিটাল সেন্টার, মেহেরপুর।</p>
                ...
                <tr>
                    ...
                    <td style="height:36px; width:43%">
                        <p style="text-align: center;">স্বাস্থ্যসম্মত শাক সবজি ও ফলমূল উৎপাদন ( মোঃ মোফাখখারুল ইসলাম)</p>
                    </td>
                </tr>
                <tr>
                    <td style="height:36px; width:6.44%">
                    ...
                    <td style="height:36px; width:43%">
                        <p style="text-align: center;">মোমিনপুর মাধ্যমিক বিদ্যালয়, মেহেরপুর সদর।</p>
                ...
                <tr>
                    ...
                    <td style="height:42px; width:43%">
                        <p style="text-align: center;">মেহেরপুর সরকারি মহিলা কলেজ।</p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="height:41px; width:43%">
                        <p style="text-align: center;">দারিয়াপুর গাওছিয়া দাখিল মাদ্রাসা।</p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="height:30px; width:43%">
                        <p style="text-align: center;">মেহেরপুর পৌরসভা।</p>
                    </td>
                </tr>
                <tr>
                    <td style="height:36px; width:6.44%">
                    ...
                    <td style="height:36px; width:43%">
                        <p style="text-align: center;">জেলা প্রশাসকের কার্যালয়, মেহেরপুর।</p>
                    </td>
                </tr>
                <tr>
                    <td style="height:30px; width:6.44%">
                ...
                <tr>
                    ...
                    <td style="height:29px; width:43%">
                        <p style="text-align: center;">মোঃ সাদ্দাম হোসেন ( সেলফ প্রটেক্ট অ্যাপ)</p>
                    </td>
                </tr>
                <tr>
