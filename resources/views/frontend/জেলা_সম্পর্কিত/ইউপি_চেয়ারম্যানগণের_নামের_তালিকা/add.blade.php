...
@section('title')
মেহেরপুর জেলা | ইউপি চেয়ারম্যান | সংযোজন
@endsection

@section('contant')
<div id="printable_area">
    <h3>ইউপি চেয়ারম্যানের তথ্য সংযোজন</h3>
    <div style="border: 1px solid #e9e2e2; padding:5px">
        ...
        <form action="{{ url('/জেলা-সম্পর্কিত/ইউপি-চেয়ারম্যানগণের-নামের-তালিকা/insert') }}" method="POST" enctype="multipart/form-data" style="padding: 10px; background: #dedede24;">
            @csrf
            <div class="mb-3">
