...
<div id="printable_area">
    <h3>
        মেহেরপুর জেলার হাটবাজারের তালিকা
    </h3>
    ...
    <table class="table table-advanced" style="text-align: center;">
        ...
        <thead style="font-weight: bold;">
            <tr>
                ...
                <td class="td_bold">ইজারা মূল্য</td>
        ...
        <tbody>
            ...
            <tr>
                ...
                @endcan
                <td>
                    <a href="{{ url('/জেলা-সম্পর্কিত/হাটবাজার/'.$item->name.'/'.$item->id) }}" class="btn-view" style="color:#fff" target="_blank">বিস্তারিত</a>
                    @can('edit')
                    <a href="{{ url('/জেলা-সম্পর্কিত/হাটবাজার/edit/'.$item->name.'/'.$item->id) }}" class="btn-edit" style="color:#fff">এডিট</a>
                    @endcan
                    @can('delete')
                    <a href="{{ url('/জেলা-সম্পর্কিত/হাটবাজার/'.$item->id) }}" class="btn-delete" style="color:#fff">ডিলেট</a>
                    @endcan
                </td>
            </tr>
            @endforeach
